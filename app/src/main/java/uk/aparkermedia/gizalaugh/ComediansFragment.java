 ...
 */
public class ComediansFragment extends Fragment {
    /**
    ...
    public static ComediansFragment newInstance(int sectionNumber) {
        ComediansFragment fragment = new ComediansFragment();
    ...
    public ComediansFragment() {
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_comedians, container, false);
        ...
        myWebView = (WebView) rootView.findViewById(R.id.webView);
            ...
            myWebView.loadUrl("http://www.gizalaugh.tv/app/android/v1/comedians.php");
